...
As a method for FDM, I choose a Operator Spliting Method(OSM). Alternative Direction Implicit(ADI) has a advantage in unconditionally stable solution and second order in time and space. However, ADI with tiny time step has a huge weakness about oscillation of solution[4]. That is why I apply the OSM.
...
** Lower version of MS Office will cause a error, since I complied in the latest version of VS. If you have a trouble with this issue, please contact me.
...
- Parallelization to better performance
